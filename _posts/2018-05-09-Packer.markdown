...
tags: [Packer]
---
Esta herramienta de la que voy a hablar a continuación. Surgen de un objetivo principal. Tener ambientes idénticos, versionados e integrados en un CI/CD. Partiendo de una primera versión base de sistema operativo, hasta llegar a una versión final de producción.
