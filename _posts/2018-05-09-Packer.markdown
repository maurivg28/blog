...
---
Uno de los objetivos a los que a veces me enfrento, es tenerener ambientes idénticos, versionados e integrados en un CI/CD. Partiendo de una primera versión base de sistema operativo, hasta llegar a una versión final de producción.
